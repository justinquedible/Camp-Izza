        ...
        <HashRouter>
          <div>
            <Switch>
              ...
              <Route
                exact
                path={"/admin/managecampers"}
                component={NewManageCampers}
              />
              ...
              <Route
                exact
                path={"/admin/attendance/bonuscamper"}
                component={BonusCamper}
              />
              <Route
                exact
              ...
              <Route
                exact
                path={"/admin/managecounselors"}
                component={ManageCounselors}
              />
              <Route
                exact
                path={"/admin/AdminCamperForm"}
                component={AdminCamperForm}
              />
              <Route
                exact
                path={"/admin/emergencyform"}
              ...
              <Route
                exact
                path={"/updatePasswordRequest/:token"}
              ...
              <Route
                exact
                path={"/counselor/attendance"}
                component={CounselorAttendance}
              />
            </Switch>
          </div>
        </HashRouter>
