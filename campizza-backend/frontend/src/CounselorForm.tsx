        ...
        <div className="CamperForm">
            ...
            <Container className="Text-Form">
                ...
                <form onSubmit={handleSubmit}>
                    <Button variant="primary" className="backButton" href="/#/CounselorInfo"> Back </Button>
                    <br/><br/>
                    <h3> Edit Profile </h3>
                    <br/>
                    ...
                    <input type="text" required onChange={handleChange('phone')} defaultValue={values.phone}
                           placeholder={"000-000-0000"}/>

                    <p><b>* </b>Alternative Phone Number</p>
                    <input type="text" required onChange={handleChange('altPhone')} defaultValue={values.altPhone}
                           placeholder={"000-000-0000"}/>

                    <p><b>* </b>Email</p>
                    <input type="text" required onChange={handleChange('email')} defaultValue={values.email}/>
                    ...
                    <p><b>* </b>Do you have any chronic conditions or illnesses? If <u>yes</u>, please list conditions.</p>
                    ...
                    <p><b>* </b>Do you have any allergies and/or dietary restrictions? If <u>yes</u>, please list restrictions.</p>
                    ...
                    <p><b>* </b>Will you be taking any medication at camp? If <u>yes</u>, please list medications.
                    </p>
                    ...
                    <p><b>* </b>Are there any camp activities that you cannot participate in? If  <u>yes</u>, please list
                        activities.</p>
                    ...
                    <p><b>* </b>Have you undergone any medical treatments? If <u>yes</u>, please list treatments.</p>
                    ...
                    <p><b>* </b>Have you received all current immunizations?</p>
                    ...
                    <p><b>* </b>What is the date (approximate if necessary) of your last tetanus shot?</p>
