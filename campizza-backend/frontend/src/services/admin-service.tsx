...
const getCamperSchedule = (camperID: number) => {
  ...
  return axios
    .post(API_URL + "adminAPI/registeredProgram/getCamperWeeks/" + year, {
      camperID,
    })
    .catch();
};
...
const getAttendanceInDate = (date: Date | any) => {
  ...
  return axios.get(API_URL + "api/attendances/getAttendance", { params: data, headers: requestHeader }).catch();
};
...
const updateBonusAttendance = (
  date: Date | any,
  bonusCamperName: string | any,
  bonusCamperGroup: string | any,
  time: string | any
) => {
  return axios.post(API_URL + "api/attendances/updateBonusCamperStringAttendance", {
    date,
    bonusCamperName,
    bonusCamperGroup,
    time,
...
const setGroupLimits = (
  ...
  let year = date.getFullYear();
  return axios
    .post(API_URL + "adminAPI/registeredProgram/setYearGroupLimits/", {
      year,
      datesAMLimit,
      datesPMLimit,
      cocoAMLimit,
...
const setProgramPrice = (
  ...
  return axios
    .post(API_URL + "adminAPI/registeredProgram/setYearPricing/", {
      year,
      pricing_base_rate,
      pricing_extra_rate,
      extra_shirts,
...
const setProgramWeeks = (
  allWeeks: (string | number | never[])[][],
  cutoff: string,
  amTimeStart: any,
  amTimeEnd: any,
  amECTimeStart: any,
  ...
  fullECTimeEnd: any,
  amSelected: boolean,
  amECSelected: boolean,
  pmSelected: boolean,
  pmECSelected: boolean,
  fullSelected: boolean,
  fullECSelected: boolean
) => {
  const date = new Date();
  let year = date.getFullYear();

  return axios
    .post(API_URL + "adminAPI/registeredProgram/editWeeks/" + year, {
      year,
      allWeeks,
      cutoff,
      amTimeStart,
...
const setWeeksHolidays = (weekID: number, holiday: String) => {
  return axios
    .post(API_URL + "adminAPI/registeredProgram/setWeekHolidays/" + weekID, {
      holiday,
    })
    .catch();
};
...
const removeWeeksHolidays = (weekID: number, holidayID: number) => {
  return axios
    .post(API_URL + "adminAPI/registeredProgram/removeWeekHolidays/" + weekID, {
      holidayID,
    })
    .catch();
};
...
const requestInfo = (
  ...
  return axios
    .post(API_URL + "adminAPI/roster/requestInfo", {
      personalchildID,
      personalfirstName,
      personallastName,
      personalgender,
      ...
      weekswk8PM,
      weeksextendedCare,
      attendancewk1Expected,
      attendancewk1Actual,
      attendancewk2Expected,
      attendancewk2Actual,
      attendancewk3Expected,
      attendancewk3Actual,
      attendancewk4Expected,
      attendancewk4Actual,
      attendancewk5Expected,
      attendancewk5Actual,
      attendancewk6Expected,
      attendancewk6Actual,
      attendancewk7Expected,
      attendancewk7Actual,
      attendancewk8Expected,
      attendancewk8Actual,
      ...
      emergencye1Phone,
      emergencye1Authorized,
      emergencye2FirstName,
      emergencye2LastName,
      emergencye2Relationship,
      emergencye2Phone,
      emergencye2Authorized,
      paymentsamountPaid,
      paymentscredit,
      paymentsearlyBird,
      counselorscounselorID,
      counselorscounselorEmail,
      counselorscounselorGroup,
      counselorscounselorStatus,
      personalyearCreated,
      year,
    })
    .catch();
...
const emergencyInfo = (camperId: number) => {
  let personalfirstName = true;
  let personallastName = true;
  let personalgender = true;
  let personaldob = true;
  let personalschool = true;
  let personalgrade = true;
  let weeksextendedCare = true;
  let medicalInfodoctorName = true;
  let medicalInfodoctorPhone = true;
  let medicalInfoinsurance = true;
  let medicalInfopolicyholder = true;
  let medicalInfoillnesses = true;
  let medicalInfoallergiesDiet = true;
  let medicalInfomedications = true;
  let medicalInfoactivities = true;
  let medicalInfoactivityNames = true;
  let medicalInfotreatments = true;
  let medicalInfotreatmentNames = true;
  let medicalInfoimmunizations = true;
  let medicalInfotetanus = true;
  let medicalInfocomments = true;
  let parentg1FirstName = true;
  let parentg1LastName = true;
  let parentg2FirstName = true;
  let parentg2LastName = true;
  let parentemail1 = true;
  let parentemail2 = true;
  let parentg1Phone1 = true;
  let parentg1Phone2 = true;
  let parentg2Phone1 = true;
  let parentg2Phone2 = true;
  let emergencye1FirstName = true;
  let emergencye1LastName = true;
  let emergencye1Relationship = true;
  let emergencye1Phone = true;
  let emergencye2FirstName = true;
  let emergencye2LastName = true;
  let emergencye2Relationship = true;
  let emergencye2Phone = true;
