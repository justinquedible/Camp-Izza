...
const SignUpCounselor: React.FC<loginDetailsProp> = () => {
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
        ...
        if (await AuthService.counselorRegister(firstName, lastName, loginEmail, password)) {
        ...
        <div className={"login"}>
            ...
            <div className={"login-form"}>
                ...
                <Form onSubmit={handleSubmit}>
                    ...
                    <Button variant="outline-primary" className="login-button" type="submit" href="/#/counselor/pending" onClick={handleSubmit}>
                        Sign Up
                    </Button>
                    <p className="fineText"> Upon sign up as a counselor, your account will be pending until admin approval is received.
                    If admin approval is not received, your account will be deleted.
                    Please contact Camp Izza for further details. </p>
